      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* Logo da empresa */}
            <div className="mt-8 p-6 bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl">
              <img 
                src="/img/logo-neitech.png" 
                alt="NeiTech Soluções Web" 
                className="h-16 w-auto mx-auto filter brightness-75"
              />
            </div>
          </div>
