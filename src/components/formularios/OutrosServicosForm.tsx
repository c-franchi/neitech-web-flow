...
const OutrosServicosForm: React.FC<OutrosServicosFormProps> = ({ respostas, setRespostas }) => {
  ...
  return (
    <form className="space-y-8" aria-label="Formulário de outros serviços" autoComplete="on">
      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-lg border border-indigo-200">
        <h3 className="text-xl font-bold text-indigo-900 mb-2" id="form-title">Outros Serviços</h3>
        <p className="text-indigo-700">Conte-nos mais sobre seu projeto personalizado</p>
      </div>
      {/* Descrição Detalhada */}
      <fieldset className="space-y-3" aria-labelledby="descricao-detalhada-label">
        <legend id="descricao-detalhada-label" className="block text-sm font-semibold text-gray-800 mb-1">Descreva detalhadamente seu projeto *</legend>
        <textarea
        ...
        <fieldset className="space-y-3" aria-labelledby="exemplos-referencias-label">
          <legend id="exemplos-referencias-label" className="block text-sm font-semibold text-gray-800 mb-1">Você tem exemplos, referências ou algo similar ao que precisa?</legend>
          <textarea
            id="exemplosReferencias"
            className="w-full p-4 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
        ...
        <fieldset className="space-y-3" aria-labelledby="funcionalidades-esperadas-label">
          <legend id="funcionalidades-esperadas-label" className="block text-sm font-semibold text-gray-800 mb-1">Liste as principais funcionalidades que você espera</legend>
          <textarea
            id="funcionalidadesEsperadas"
            className="w-full p-4 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
        ...
        {/* Orçamento Estimado */}
        <fieldset className="space-y-3" aria-labelledby="orcamento-estimado-label">
          <legend id="orcamento-estimado-label" className="block text-sm font-semibold text-gray-800 mb-1">Você tem um orçamento estimado em mente?</legend>
          <select 
        ...
        {/* Prazo */}
        <fieldset className="space-y-3" aria-labelledby="prazo-label">
          <legend id="prazo-label" className="block text-sm font-semibold text-gray-800 mb-1">Qual é o prazo ideal para entrega? *</legend>
          <select 
            id="prazoEsperado"
            className="w-full p-4 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
